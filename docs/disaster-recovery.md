...
- **Cache-only or tiny / no persistent state worth backing up**: `recyclarr`, `renovate`, `ddns-updater`, `walker`, `zepp`, `byparr`, `dozzle`, `convertx`, `excalidraw`, `git`, `jaw-dev`, `power-badge`, `adguard`
